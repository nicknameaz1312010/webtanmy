    ...
    <div class="flex items-center justify-between h-16 lg:h-20">
      ...
      <div class="flex items-center gap-3">
        <a href="#" class="flex items-baseline gap-0">
          <span class="text-2xl lg:text-3xl font-black tracking-tight" style="color:#014289">TÂN</span>
          <span class="text-2xl lg:text-3xl font-black tracking-tight" style="color:#ED1C24">MỸ</span>
        </a>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10 pb-12">
      ...
      <div class="lg:col-span-1">
        <div class="flex items-baseline gap-0 mb-4">
          <span class="text-2xl font-black tracking-tight" style="color:#014289">TÂN</span>
          <span class="text-2xl font-black tracking-tight" style="color:#ED1C24">MỸ</span>
